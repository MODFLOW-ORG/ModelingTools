...
// (DO NOT EDIT: machine generated header) 'GLXCollection.pas' rev: 37.00 (Windows)
...
class PASCALIMPLEMENTATION TXCollectionItem : public Glpersistentclasses::TGLInterfacedPersistent
{
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GLXCOLLECTION)
using namespace Glxcollection;
#endif
#pragma pack(pop)
#pragma option pop
