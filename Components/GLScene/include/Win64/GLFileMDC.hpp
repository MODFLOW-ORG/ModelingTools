...
// (DO NOT EDIT: machine generated header) 'GLFileMDC.pas' rev: 37.00 (Windows)
...
class PASCALIMPLEMENTATION TGLMDCVectorFile : public Glvectorfileobjects::TGLVectorFile
{
...
public:
	/* TGLVectorFile.Create */ inline __fastcall virtual TGLMDCVectorFile(System::Classes::TPersistent* AOwner) : Glvectorfileobjects::TGLVectorFile(AOwner) { }
