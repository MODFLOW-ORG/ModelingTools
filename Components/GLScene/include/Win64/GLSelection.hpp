...
// (DO NOT EDIT: machine generated header) 'GLSelection.pas' rev: 37.00 (Windows)
...
public:
	Glbaseclasses::TGLUpdateAbleComponent* AObject;
...
class PASCALIMPLEMENTATION TGLPickList : public Glpersistentclasses::TPersistentObjectList
{
...
public:
	/* TPersistentObjectList.Destroy */ inline __fastcall virtual ~TGLPickList() { }
	
public:
	/* TPersistentObject.CreateFromFiler */ inline __fastcall TGLPickList(Glpersistentclasses::TVirtualReader* reader) : Glpersistentclasses::TPersistentObjectList(reader) { }
