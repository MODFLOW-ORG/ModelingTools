...
// (DO NOT EDIT: machine generated header) 'OpenGLAdapter.pas' rev: 37.00 (Windows)
...
public:
	...
	Opengltokens::PFNGLClearBufferData ClearBufferData;
	Opengltokens::PFNGLClearBufferSubData ClearBufferSubData;
	Opengltokens::PFNGLClearNamedBufferData ClearNamedBufferData;
	Opengltokens::PFNGLClearNamedBufferSubData ClearNamedBufferSubData;
	Opengltokens::PFNGLInvalidateTexSubImage InvalidateTexSubImage;
	Opengltokens::PFNGLInvalidateTexImage InvalidateTexImage;
	Opengltokens::PFNGLInvalidateBufferSubData InvalidateBufferSubData;
	Opengltokens::PFNGLInvalidateBufferData InvalidateBufferData;
	Opengltokens::PFNGLInvalidateFramebuffer InvalidateFramebuffer;
	Opengltokens::PFNGLInvalidateSubFramebuffer InvalidateSubFramebuffer;
	Opengltokens::PFNGLMultiDrawArraysIndirect MultiDrawArraysIndirect;
	Opengltokens::PFNGLMultiDrawElementsIndirect MultiDrawElementsIndirect;
	Opengltokens::PFNGLBindVertexBuffer BindVertexBuffer;
	Opengltokens::PFNGLVertexAttribFormat VertexAttribFormat;
	Opengltokens::PFNGLVertexAttribIFormat VertexAttribIFormat;
	Opengltokens::PFNGLVertexAttribLFormat VertexAttribLFormat;
	Opengltokens::PFNGLVertexAttribBinding VertexAttribBinding;
	Opengltokens::PFNGLVertexBindingDivisor VertexBindingDivisor;
	Opengltokens::PFNGLVertexArrayBindVertexBuffer VertexArrayBindVertexBuffer;
	Opengltokens::PFNGLVertexArrayVertexAttribFormat VertexArrayVertexAttribFormat;
	Opengltokens::PFNGLVertexArrayVertexAttribIFormat VertexArrayVertexAttribIFormat;
	Opengltokens::PFNGLVertexArrayVertexAttribLFormat VertexArrayVertexAttribLFormat;
	Opengltokens::PFNGLVertexArrayVertexAttribBinding VertexArrayVertexAttribBinding;
	Opengltokens::PFNGLVertexArrayVertexBindingDivisor VertexArrayVertexBindingDivisor;
	...
	Opengltokens::PFNGLDispatchCompute DispatchCompute;
	Opengltokens::PFNGLDispatchComputeIndirect DispatchComputeIndirect;
	Opengltokens::PFNGLShaderStorageBlockBinding ShaderStorageBlockBinding;
	...
	Opengltokens::PFNGLFramebufferParameteri FramebufferParameteri;
	Opengltokens::PFNGLNamedFramebufferParameteri NamedFramebufferParameteri;
	Opengltokens::PFNGLGetNamedFramebufferParameteriv GetNamedFramebufferParameteriv;
	...
	Opengltokens::PFNGLGetInternalformati64v GetInternalformati64v;
	Opengltokens::PFNGLGetProgramInterfaceiv GetProgramInterfaceiv;
	Opengltokens::PFNGLGetProgramResourceIndex GetProgramResourceIndex;
	Opengltokens::PFNGLGetProgramResourceName GetProgramResourceName;
	Opengltokens::PFNGLGetProgramResourceiv GetProgramResourceiv;
	Opengltokens::PFNGLGetProgramResourceLocation GetProgramResourceLocation;
	Opengltokens::PFNGLGetProgramResourceLocationIndex GetProgramResourceLocationIndex;
	...
	Opengltokens::PFNGLCopyImageSubData CopyImageSubData;
	Opengltokens::PFNGLTexBufferRange TexBufferRange;
	Opengltokens::PFNGLTextureBufferRange TextureBufferRange;
	Opengltokens::PFNGLTexStorage2DMultisample TexStorage2DMultisample;
	Opengltokens::PFNGLTexStorage3DMultisample TexStorage3DMultisample;
	Opengltokens::PFNGLTextureStorage2DMultisample TextureStorage2DMultisample;
	Opengltokens::PFNGLTextureStorage3DMultisample TextureStorage3DMultisample;
	Opengltokens::PFNGLBufferStorage BufferStorage;
	Opengltokens::PFNGLClearTexImage ClearTexImage;
	Opengltokens::PFNGLClearTexSubImage ClearTexSubImage;
	Opengltokens::PFNGLBindBuffersBase BindBuffersBase;
	Opengltokens::PFNGLBindBuffersRange BindBuffersRange;
	Opengltokens::PFNGLBindTextures BindTextures;
	Opengltokens::PFNGLBindSamplers BindSamplers;
	Opengltokens::PFNGLBindImageTextures BindImageTextures;
	Opengltokens::PFNGLBindVertexBuffers BindVertexBuffers;
	Opengltokens::PFNGLTextureView TextureView;
	...
	Opengltokens::PFNGLGetObjectLabel GetObjectLabel;
	...
	__int64 __stdcall (*VDPAURegisterVideoSurfaceNV)(const void * vdpSurface, unsigned target, Opengltokens::TGLsizei numTextureNames, const Opengltokens::PGLuint textureNames);
	__int64 __stdcall (*VDPAURegisterOutputSurfaceNV)(const void * vdpSurface, unsigned target, Opengltokens::TGLsizei numTextureNames, const Opengltokens::PGLuint textureNames);
