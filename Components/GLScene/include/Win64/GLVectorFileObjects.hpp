...
// (DO NOT EDIT: machine generated header) 'GLVectorFileObjects.pas' rev: 37.00 (Windows)
...
typedef System::StaticArray<PVertexBoneWeightArray, 134217728> TVerticesBoneWeights;
