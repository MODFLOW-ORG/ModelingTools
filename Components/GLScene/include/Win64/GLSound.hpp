...
// (DO NOT EDIT: machine generated header) 'GLSound.pas' rev: 37.00 (Windows)
...
public:
	...
	Glsoundfileobjects::TGLSoundSampling* __fastcall Sampling();
...
class PASCALIMPLEMENTATION TGLSoundManager : public Glbaseclasses::TGLCadenceAbleComponent
{
...
public:
	__fastcall virtual TGLBSoundEmitter(Glxcollection::TXCollection* AOwner);
...
extern DELPHI_PACKAGE TGLBSoundEmitter* __fastcall GetOrCreateSoundEmitter(Glscene::TGLBehaviours* behaviours)/* overload */;
extern DELPHI_PACKAGE TGLBSoundEmitter* __fastcall GetOrCreateSoundEmitter(Glscene::TGLBaseSceneObject* obj)/* overload */;
}	/* namespace Glsound */
