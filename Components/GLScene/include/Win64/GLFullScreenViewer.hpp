...
// (DO NOT EDIT: machine generated header) 'GLFullScreenViewer.pas' rev: 37.00 (Windows)
...
__published:
	...
	__property Glcontext::TGLVSyncMode VSync = {read=FVSync, write=FVSync, default=0};
