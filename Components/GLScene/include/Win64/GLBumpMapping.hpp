...
// (DO NOT EDIT: machine generated header) 'GLBumpMapping.pas' rev: 37.00 (Windows)
...
//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE void __fastcall CalcObjectSpaceLightVectors(const Glvectorgeometry::TAffineVector &Light, Glvectorlists::TAffineVectorList* Vertices, Glvectorlists::TVectorList* Colors);
...
extern DELPHI_PACKAGE void __fastcall CalcTangentSpaceLightVectors(const Glvectorgeometry::TAffineVector &Light, Glvectorlists::TAffineVectorList* Vertices, Glvectorlists::TAffineVectorList* Normals, Glvectorlists::TAffineVectorList* Tangents, Glvectorlists::TAffineVectorList* BiNormals, Glvectorlists::TVectorList* Colors);
