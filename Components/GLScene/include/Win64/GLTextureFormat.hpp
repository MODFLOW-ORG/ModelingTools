...
// (DO NOT EDIT: machine generated header) 'GLTextureFormat.pas' rev: 37.00 (Windows)
...
extern DELPHI_PACKAGE unsigned __fastcall DecodeGLTextureTarget(const TGLTextureTarget TextureTarget);
