...
typedef System::StaticArray<Glvectorgeometry::PByteVector, 134217728> TByteRaster;
...
typedef System::StaticArray<Glvectorgeometry::PFloatVector, 134217728> TSingleRaster;
