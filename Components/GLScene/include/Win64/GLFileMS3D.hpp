...
// (DO NOT EDIT: machine generated header) 'GLFileMS3D.pas' rev: 37.00 (Windows)
...
public:
	System::Byte Flags;
	Glvectortypes::TD3DVector Vertex;
	char BoneId;
...
public:
	...
	System::StaticArray<Glvectortypes::TD3DVector, 3> VertexNormals;
...
public:
	float Time;
	Glvectortypes::TD3DVector Rotation;
};
#pragma pack(pop)
...
public:
	float Time;
	Glvectortypes::TD3DVector Position;
};
#pragma pack(pop)
...
#pragma pack(push,1)
class PASCALIMPLEMENTATION TGLMS3DVectorFile : public Glvectorfileobjects::TGLVectorFile
{
...
public:
	/* TGLVectorFile.Create */ inline __fastcall virtual TGLMS3DVectorFile(System::Classes::TPersistent* AOwner) : Glvectorfileobjects::TGLVectorFile(AOwner) { }
