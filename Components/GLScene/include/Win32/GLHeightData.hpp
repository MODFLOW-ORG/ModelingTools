...
// (DO NOT EDIT: machine generated header) 'GLHeightData.pas' rev: 37.00 (Windows)
...
typedef System::StaticArray<Glvectorgeometry::PByteVector, 268435456> TByteRaster;
...
typedef System::StaticArray<Glvectorgeometry::PFloatVector, 268435456> TSingleRaster;
...
class PASCALIMPLEMENTATION TGLHeightData : public Glbaseclasses::TGLUpdateAbleObject
{
...
public:
	...
	__property Glvectorgeometry::TTexPoint TextureCoordinatesOffset = {read=FTCOffset, write=FTCOffset};
	__property Glvectorgeometry::TTexPoint TextureCoordinatesScale = {read=FTCScale, write=FTCScale};
...
private:
	typedef System::DynamicArray<Glvectorgeometry::PByteVector> _TGLBitmapHDS__1;
