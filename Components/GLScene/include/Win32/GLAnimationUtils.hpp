...
// (DO NOT EDIT: machine generated header) 'GLAnimationUtils.pas' rev: 37.00 (Windows)
...
//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE Glvectorgeometry::TAffineVector __fastcall Tweener(const Glvectorgeometry::TAffineVector &Current, const Glvectorgeometry::TAffineVector &Target, float Time, float Duration, TEaseType EaseType)/* overload */;
extern DELPHI_PACKAGE Glvectortypes::TVector4f __fastcall Tweener(const Glvectorgeometry::TVector &Current, const Glvectorgeometry::TVector &Target, float Time, float Duration, TEaseType EaseType)/* overload */;
