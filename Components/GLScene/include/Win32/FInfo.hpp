...
// (DO NOT EDIT: machine generated header) 'FInfo.pas' rev: 37.00 (Windows)
...
protected:
	void __fastcall LoadContributors();
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FINFO)
