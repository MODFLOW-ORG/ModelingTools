...
// (DO NOT EDIT: machine generated header) 'GLAnimatedSprite.pas' rev: 37.00 (Windows)
...
//-- type declarations -------------------------------------------------------
#pragma pack(push,4)
class PASCALIMPLEMENTATION TGLSpriteAnimFrame : public Glxcollection::TXCollectionItem
{
...
public:
	/* TXCollectionItem.Create */ inline __fastcall virtual TGLSpriteAnimFrame(Glxcollection::TXCollection* aOwner) : Glxcollection::TXCollectionItem(aOwner) { }
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TGLSpriteAnimFrameList : public Glxcollection::TXCollection
{
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TGLSpriteAnimation : public Glxcollection::TXCollectionItem
{
	typedef Glxcollection::TXCollectionItem inherited;
...
public:
	__fastcall virtual TGLSpriteAnimation(Glxcollection::TXCollection* aOwner);
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TGLSpriteAnimationList : public Glxcollection::TXCollection
{
	typedef Glxcollection::TXCollection inherited;
