...
// (DO NOT EDIT: machine generated header) 'GLSGenerics.pas' rev: 37.00 (Windows)
...
public:
	/* {GLSGenerics}GOrderedList<GLSGenerics_GStack<T>_T>.Create */ inline __fastcall virtual GStack__1() : GOrderedList__1<T>() { }
	/* {GLSGenerics}GOrderedList<GLSGenerics_GStack<T>_T>.Destroy */ inline __fastcall virtual ~GStack__1() { }
...
protected:
	virtual void __fastcall PushItem(T AItem);
public:
	/* {GLSGenerics}GOrderedList<GLSGenerics_GQueue<T>_T>.Create */ inline __fastcall virtual GQueue__1() : GOrderedList__1<T>() { }
	/* {GLSGenerics}GOrderedList<GLSGenerics_GQueue<T>_T>.Destroy */ inline __fastcall virtual ~GQueue__1() { }
