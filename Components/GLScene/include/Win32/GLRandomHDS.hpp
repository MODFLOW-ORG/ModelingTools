...
// (DO NOT EDIT: machine generated header) 'GLRandomHDS.pas' rev: 37.00 (Windows)
...
public:
	int x;
	int z;
	Glheightdata::TGLHeightDataState State;
};
...
typedef System::DynamicArray<float> Glrandomhds__1;

typedef System::DynamicArray<System::DynamicArray<float> > TMapOfSingle;

typedef System::DynamicArray<Glvectortypes::TVector4f> Glrandomhds__2;
...
class PASCALIMPLEMENTATION TGLBaseRandomHDS : public Glheightdata::TGLHeightDataSource
{
...
__published:
	__property Glterrainrenderer::TGLTerrainRenderer* TerrainRenderer = {read=FTerrainRenderer, write=SetTerrainRenderer};
...
private:
	...
	Glheightdata::TStartPreparingDataEvent fOnCreateDefaultTile;
	...
	void __fastcall fDefaultOnCreateDefaultTile(Glheightdata::TGLHeightData* heightData);
	...
	void __fastcall SetOnCreateDefaultTile(const Glheightdata::TStartPreparingDataEvent Value);
...
protected:
	...
	__property Glheightdata::TStartPreparingDataEvent OnCreateDefaultTile = {read=fOnCreateDefaultTile, write=SetOnCreateDefaultTile};
	virtual void __fastcall SetCyclic(const bool Value);
	void __fastcall SetSize(const int aSize);
...
private:
	...
	void __fastcall FPostRenderSeaStatic(Glrendercontextinfo::TGLRenderContextInfo &rci, System::Classes::TList* &HeightDatas);
	void __fastcall FPostRenderSeaDynamic(Glrendercontextinfo::TGLRenderContextInfo &rci, System::Classes::TList* &HeightDatas);
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GLRANDOMHDS)
using namespace Glrandomhds;
#endif
#pragma pack(pop)
#pragma option pop
