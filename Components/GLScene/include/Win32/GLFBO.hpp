...
// (DO NOT EDIT: machine generated header) 'GLFBO.pas' rev: 37.00 (Windows)
...
protected:
	void __fastcall AttachTexture(const unsigned attachment, const unsigned textarget, const unsigned texture, const Opengltokens::TGLint level, const Opengltokens::TGLint layer)/* overload */;
