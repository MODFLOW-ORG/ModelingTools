...
// (DO NOT EDIT: machine generated header) 'OpenGLVCL.pas' rev: 37.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_OPENGLVCL)
using namespace Openglvcl;
#endif
#pragma pack(pop)
#pragma option pop
