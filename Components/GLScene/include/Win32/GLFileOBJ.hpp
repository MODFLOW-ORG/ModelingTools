...
public:
	...
	Glvectorgeometry::TVector __fastcall MaterialVectorProperty(const System::UnicodeString materialName, const System::UnicodeString propertyName, const Glvectorgeometry::TVector &defaultValue);
public:
