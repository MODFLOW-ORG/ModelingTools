...
// (DO NOT EDIT: machine generated header) 'GLSceneRegister.pas' rev: 37.00 (Windows)
...
protected:
	System::Uitypes::TColor __fastcall ColorToBorderColor(const Glcolor::TColorVector &aColor, bool selected);
...
public:
	...
	/* TPropertyEditor.Destroy */ inline __fastcall virtual ~TSoundFileProperty() { }
...
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TReuseableDefaultEditor() { }
...
//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE Globjectmanager::TGLObjectManager* __fastcall ObjectManager(void);
