...
// (DO NOT EDIT: machine generated header) 'GLContext.pas' rev: 37.00 (Windows)
...
protected:
	...
	Xopengl::TGLMultitextureCoordinator* FXGL;
...
public:
	...
	__property Xopengl::TGLMultitextureCoordinator* MultitextureCoordinator = {read=FXGL};
...
protected:
	...
	virtual Glstate::TQueryType __fastcall GetQueryType() = 0 ;
	__classmethod virtual bool __fastcall IsValid(const unsigned ID);
...
protected:
	...
	virtual Glstate::TQueryType __fastcall GetQueryType();
...
private:
	...
	Glvectortypes::TVector2i __fastcall GetUniform2i(const System::UnicodeString index);
	void __fastcall SetUniform2i(const System::UnicodeString index, const Glvectortypes::TVector2i &Value);
	Glvectortypes::TVector3i __fastcall GetUniform3i(const System::UnicodeString index);
	void __fastcall SetUniform3i(const System::UnicodeString index, const Glvectortypes::TVector3i &Value);
	Glvectortypes::TVector4i __fastcall GetUniform4i(const System::UnicodeString index);
	void __fastcall SetUniform4i(const System::UnicodeString index, const Glvectortypes::TVector4i &Value);
...
public:
	...
	void __fastcall SetUniformi(const System::UnicodeString index, const Glvectortypes::TVector2i &val)/* overload */;
	void __fastcall SetUniformi(const System::UnicodeString index, const Glvectortypes::TVector3i &val)/* overload */;
	void __fastcall SetUniformi(const System::UnicodeString index, const Glvectortypes::TVector4i &val)/* overload */;
	void __fastcall SetUniformf(const System::UnicodeString index, const float val)/* overload */;
	void __fastcall SetUniformf(const System::UnicodeString index, const Glvectortypes::TVector2f &val)/* overload */;
	void __fastcall SetUniformf(const System::UnicodeString index, const Glvectortypes::TVector3f &val)/* overload */;
	void __fastcall SetUniformf(const System::UnicodeString index, const Glvectortypes::TVector4f &val)/* overload */;
	__property int Uniform1i[const System::UnicodeString index] = {read=GetUniform1i, write=SetUniform1i};
	__property Glvectortypes::TVector2i Uniform2i[const System::UnicodeString index] = {read=GetUniform2i, write=SetUniform2i};
	__property Glvectortypes::TVector3i Uniform3i[const System::UnicodeString index] = {read=GetUniform3i, write=SetUniform3i};
...
extern DELPHI_PACKAGE Opengladapter::TGLExtensionsAndEntryPoints* GL;
extern DELPHI_PACKAGE Xopengl::TGLMultitextureCoordinator* xgl;
extern DELPHI_PACKAGE bool vMainThread;
extern DELPHI_PACKAGE Opengladapter::TGLExtensionsAndEntryPoints* GLwithoutContext;
