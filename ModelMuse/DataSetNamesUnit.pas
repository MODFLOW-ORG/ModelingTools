...
//  KFootprint_Code = 'Footprint_Code';
  ...
  StrDRNDDRN = 'Drain Discharge Scaling';
  StrDRNMultiplier = 'Drain Multiplier';
  ...
  StrMODFLOWRiverMultiplier = 'RIV Multiplier';
...
//  K_IFlowFaceLAK = 'IFLOWFACE_LAK';
  ...
  K_IFlowFaceExplanation = sLineBreak +
      ...
      'faces. For a DIS-grid cell, IFLOWFACE = 1 corresponds to the we' +
      'stern face, i.e., the face parallel to the y axis that has the ' +
      ...
      'OWFACE = -1 corresponds to the cell top.' + sLineBreak +
      sLineBreak + 'The cell faces for D' +
...
//  StrLakeMf6 = KLakeMf6;
  ...
  StrDefaultGmshPath = 'C:\gmsh-4.15.2-Windows64\gmsh.exe';
  ...
  StrDefaultModflow6Path =      'C:\WRDAPP\mf6.8.0_win64\bin\mf6.exe';
  StrZoneBudgetMf6DefaultPath = 'C:\WRDAPP\mf6.8.0_win64\bin\zbud6.exe';
