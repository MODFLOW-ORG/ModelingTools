...
procedure TFmpCropIDCollection.AssignArrayCellValues(DataSets: TList;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        Cells.Capacity := Cells.Count + Max(Length(LocalBoundaryStorage.CropIDArray), Cells.Count div 4);
      end;
//      Cells.CheckRestore;
