...
procedure TFmpPrecipCollection.AssignArrayCellValues(DataSets: TList;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        Cells.Capacity := Cells.Count + Max(Length(LocalBoundaryStorage.PrecipArray), Cells.Count div 4);
      end;
//      Cells.CheckRestore;
