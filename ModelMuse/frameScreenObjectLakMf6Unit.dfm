inherited frameScreenObjectLakMf6: TframeScreenObjectLakMf6
  ...
  object pcLake: TPageControl
    ...
    object tabLakeProperties: TTabSheet
      ...
      object grpConnectionDirections: TGroupBox
        Left = 5
        Top = 34
        Width = 176
        Height = 63
        Caption = 'Connection directions'
        TabOrder = 1
      ...
      object seOutletCount: TJvSpinEdit
        Left = 5
        Top = 5
        Width = 49
        Height = 23
        ...
        TabOrder = 0
        OnChange = seOutletCountChange
        OnEnter = seOutletCountEnter
      end
