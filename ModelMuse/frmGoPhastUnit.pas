...
uses System.UITypes,
  ...
  GLWidget, frame3DViewUnit, IniFiles, MostRecentlyUsedFiles,
  ToolWin, frmUndoUnit, ModflowGridUnit, AbstractGridUnit,
  JvExExtCtrls, JvNetscapeSplitter, frmRunModflowUnit,
  frmRunPhastUnit, ModelMateClassesUnit, frmRunModpathUnit,
  frmRunZoneBudgetUnit, RbwModelCube, frmRunModelMateUnit,
  frmRunMt3dmsUnit, JvExControls, JvArrowButton,
...
uses
  ...
  InteractiveTools, frmRulerOptionsUnit, frmGoToUnit,
  frmFormulaErrorsUnit, frmGenerateGridUnit,
  ...
  frmSearchUnit, frmSelectedObjectsUnit, frmShowHideObjectsUnit,
  ...
  frmManageFluxObservationsUnit, ZLib,
  ...
  ContourExport, frmExportCSVUnit, frmChildModelsUnit,
  frmImportAsciiRasterUnit, CustomModflowWriterUnit,
  ZoneBudgetWriterUnit, frmDisplayDataUnit, IOUtils,
  ...
  SutraBoundariesUnit, frmSutraOutputControlUnit,
  ...
  frmSwrTabfilesUnit, frmSwrReachGeometryUnit,
  ...
  PlProcUnit, SutraImportUnit, frmSvdaPrepInputUnit,
...
begin
  ...
  acRipPlantGroups.Visible := ModelSelection in [msModflowFmp, msModflowOwhm2];
...
//  miSWR.Visible := ModelSelection in [msModflow, msModflowNWT, msModflowFmp];
  ...
  acFarmCrops.Visible := PhastModel.ModelSelection in
    [msModflowFmp, msModflowOwhm2];
  acFarmSoils.Visible := PhastModel.ModelSelection in
    [msModflowFmp, msModflowOwhm2];
  acFarmClimate.Visible := PhastModel.ModelSelection in
    [msModflowFmp, msModflowOwhm2];
  acFarmAllotment.Visible := PhastModel.ModelSelection in
    [msModflowFmp, msModflowOwhm2];
  acEditFarms.Visible := PhastModel.ModelSelection in
    [msModflowFmp, msModflowOwhm2];
  miFarmProcessDialogBoxes.Visible := PhastModel.ModelSelection in
    [msModflowFmp, msModflowOwhm2];
  ...
  acImportModelResults.Enabled :=
    PhastModel.ModelSelection in [msModflow, msModflowLGR, msModflowLGR2,
      ...
      msSutra40, msFootPrint, msModflow2015, msModflowOwhm2];
  ...
  begin
    ...
    case Value of
      ...
      msPhast, msModflow, msModflowLGR, msModflowLGR2, msModflowNWT,
        ...
        msFootPrint, msModflow2015, msModflowOwhm2:
        begin
          InvalidateViewOfModel;
          InvalidateAllViews;
        end;
...
initialization
  ...
  // See also frmMeshGenerationControlVariablesUnit
